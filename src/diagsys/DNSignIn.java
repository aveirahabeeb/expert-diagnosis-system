 ...
 * @author Mr Olayinka
 */
public class DNSignIn extends javax.swing.JFrame {
...
//System.out.println("Current relative path is: " + s);
    ...
    private void initComponents() {
        ...
        jPasswordField1.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        ...
        jLabel3.setText("New Doctor/Nurse");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try{
          ...
          conn = SqlConnect.conDB();
            st = conn.createStatement();
              rs = st.executeQuery("select * from DocNurse where UserName ='"+ID.getText()+"' and Password = '"+ password +"'  ");
                if (rs.next()){
                        this.dispose();
                          Progress();
                    }
        ...
        catch(SQLException |InterruptedException | ClassNotFoundException | HeadlessException | IOException | InstantiationException | IllegalAccessException ex){
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
      this.dispose();
         DNNew  Admin_Register = new  DNNew(this,true) ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DNSignIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
         //</editor-fold>
         //</editor-fold>
